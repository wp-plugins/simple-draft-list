...
= 2.2.4 =
* Bug: I've just noticed that if you use the editor box to hide the post from draft list you can't switch it back off again. Untick the box, save and it's ticked again. Doh. Why did noboby notice this before? It's now fixed though.
